    ...
    <div className="result-page">
      ...
      {selectedQuestion !== null && (
        <div className="question-details">
          <h3>Question: {questions[selectedQuestion].questionText}</h3>
          <p>Correct Answer: {questions[selectedQuestion].correctAnswer}</p>
          <p>Your Answer: {answers[selectedQuestion]}</p>
          <p>Explanation: {questions[selectedQuestion].explanation}</p>
        </div>
      )}
